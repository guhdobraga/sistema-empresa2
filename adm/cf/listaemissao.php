    ...
    <section class="content">
        ...
        <div class="main-title">
            <div class="title-section">
                ...
                <h2>Este formulario permite que você veja a lista das notas fiscais.</h2>
            </div>
...
?>
    ...
    document.getElementById('searchInput').addEventListener('input', function() {
            ...
            sessoes.forEach(sessao => {
                ...
                const numeroText = sessao.children[2].textContent.toLowerCase();
                const nomeText = sessao.children[1].textContent.toLowerCase();

                if (idText.includes(searchTerm) || numeroText.includes(searchTerm) || nomeText.includes(searchTerm)){
