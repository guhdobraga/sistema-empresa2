...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['placa']) && !empty($_POST['numfiscal']) && !empty($_POST['data']) && !empty($_POST['valor']) && !empty($_POST['nomev']) && !empty($_POST['comissao']) && !empty($_POST['duracao']) && !empty($_POST['cobertura']) && !empty($_POST['termos']) &&  !empty($_POST['datav']) && !empty($_POST['valortotal'])) {
...
<head>
    ...
    <title>AgroMais Ltda. | Registro De Vendas</title>
