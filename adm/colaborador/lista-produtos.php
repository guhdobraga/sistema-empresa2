...
<head>
    ...
    <title>AgroMais Ltda. | Lista de Produtos</title>
            ...
            <div class="funcionarios-section">
                ...
                <div class="lista">
                    <ul>
                        ...
                        <li><a href="listafrota.php"><img src="../../public/resources/assets/img/lista.png">Frota de Veículos</a></li>
                    </ul>
                </div>
            </div>
            <br><br><br>
...
$controller->exibirListaEstoqueC();
?>
            </div>
    </section>
